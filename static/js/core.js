...
// ===== STORAGE =====
var getUsers=()=>JSON.parse(localStorage.getItem('pge_users')||'[]');
var saveUsers=u=>localStorage.setItem('pge_users',JSON.stringify(u));
var getUpdates=()=>JSON.parse(localStorage.getItem('pge_upd')||'{}');
var saveUpdates=u=>localStorage.setItem('pge_upd',JSON.stringify(u));
var getCurrent=()=>JSON.parse(sessionStorage.getItem('pge_cur')||'null');
var setCurrent=u=>sessionStorage.setItem('pge_cur',JSON.stringify(u));
var getAutoLog=()=>JSON.parse(localStorage.getItem('pge_autoLog')||'[]');
var saveAutoLog=l=>localStorage.setItem('pge_autoLog',JSON.stringify(l.slice(-200)));
var getSentLog=()=>JSON.parse(localStorage.getItem('pge_sent')||'{}');
var saveSentLog=s=>localStorage.setItem('pge_sent',JSON.stringify(s));
var getAutoOn=()=>localStorage.getItem('pge_autoOn')!=='0';
var setAutoOn=v=>localStorage.setItem('pge_autoOn',v?'1':'0');
...
// WA CLOUD API
// ====================================================
var getWaCfg = () => JSON.parse(localStorage.getItem('pge_wacfg') || '{}');
var saveWaCfg = c => localStorage.setItem('pge_wacfg', JSON.stringify(c));
